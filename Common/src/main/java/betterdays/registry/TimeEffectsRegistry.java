...
import static betterdays.utils.ResourceLocationHelper.prefix;
...
public class TimeEffectsRegistry {
    ...
    public static final ResourceKey<Registry<TimeEffect>> KEY = ResourceKey.createRegistryKey(prefix("time_effect"));
